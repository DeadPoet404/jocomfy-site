      ...
      <div className="mx-auto grid max-w-[1450px] grid-cols-1 gap-4 lg:grid-cols-[minmax(0,1fr)_minmax(0,1.35fr)]">
        <div className="grid gap-4">
          <article className="min-h-[390px] rounded-3xl bg-[#0d0d0d] p-8 text-white sm:p-10">
            ...
            <p className="mt-12 max-w-md text-sm leading-6 text-[#b8cef0] sm:text-base sm:leading-7">We give children the support and encouragement they need to explore ideas and build strong foundations.</p>
          </article>
          <article className="min-h-[390px] rounded-3xl bg-[#a8cdf8] p-8 text-[#111111] sm:p-10">
            ...
            <p className="mt-12 max-w-md text-sm leading-6 sm:text-base sm:leading-7">Through relationships and creativity, every child has space to discover their strengths.</p>
          </article>
        </div>
